...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'gem <gem@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/ACRL/Polaris_Gem/motion_planning/minvo_ros/src/mpc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yang/ACRL/Polaris_Gem/motion_planning/minvo_ros/devel/lib;/home/yang/ACRL/Polaris_Gem/motion_planning/minvo_ros/devel/lib;/opt/ros/noetic/lib)
