...
class mpc_bspline_ctrl_ros:
    ...
    def main(self):
        ...
        marker4_pub = rospy.Publisher("/obstacle_4", Marker, queue_size = 2)
        marker5_pub = rospy.Publisher("/obstacle_5", Marker, queue_size = 2)
        ...
        obstacle_4 = self.circle_obstacles_1
        obstacle_4['x'] -= 2
        obstacle_5 = self.circle_obstacles_2
        obstacle_5['x'] += 2
        marker4 = self.creat_marker(obstacle_4)
        marker5 = self.creat_marker(obstacle_5)
